...
2. On our github repository (https://github.com/PurePixel/3.14Rates) there is a branch called:
...
3. As well as adding code we did also make some minor formatting changes where we started working on a file and tidied
