...
abstract class CombatActor {
     ...
     *
     * @param damageTaken A list of pairs telling the CombatActor which of their rooms were hit and how much damage for
     *                    eg: [[Helm, 5], [Sails,2]]
     * @return A list of pairs of Rooms and Weapons telling the CombatManager which rooms were fired at and with which
     * weapons
     */
    public abstract List<Pair<Room, Weapon>> takeTurn(List<Pair<Room, Integer>> damageTaken);
}
