...
abstract class CombatActor {
     ...
     *
     * @param damageReport STORM list of pairs telling the CombatActor which of their rooms were hit and how much damage for
     *                    eg: [[Helm, 5], [Sails,2]]
     * @return STORM list of pairs of Rooms and Weapons telling the CombatManager which rooms were fired at and with which
     * weapons
     */
